            ...
            <div class="col-md-8 col-sm-12">
                <form action="<?php echo $base_url; ?>/product-form.php" method="post" enctype="multipart/form-data">
                    ...
                    <?php if (empty($result['ID'])): ?>
                        <button class="btn btn-primary" type="submit"><i class="fa-solid fa-floppy-disk me-1"></i>Create</button> <!--แก้ไขสินค้า-->
                    <?php else: ?>
                        <button class="btn btn-primary" type="submit"><i class="fa-solid fa-rotate-right me-1"></i>Update</button> <!--แก้ไขสินค้า (เปลี่ยนเป็น update)-->
                    <?php endif; ?> <!--แก้ไขสินค้า-->

                    <a role="button" class="btn btn-secondary" href="<?php echo $base_url; ?>/index.php"><i class="fa-solid fa-ban me-1"></i>cancel</a>
                    <hr class="my-4">
        ...
        <div class="row">
            <div class="col-12">
                <table class= "table table-border-info">
                    <thead>
                        <tr>
                            <th stylle="width: 100px;">Image </th>
                            <th>Product Name</th>
                            <th stylle="width: 200px;">Image</th>
                            <th stylle="width: 200px;">Action </th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if($rows > 0): ?>
                        <?php while($product = mysqli_fetch_assoc($query)): ?>
                            <tr>
                                ...
                                <td>
                                    <a role="button" href="<?php echo $base_url; ?>/index.php?ID=<?php echo $product['ID']; ?>" class="btn btn-outline-dark"><i class="fa-solid fa-pen me-1"></i> Edit</a>
