...
$query = mysqli_query($conn, "SELECT * FROM product_p WHERE ID IN ($ids)"); 
        ...
        <div class="row">
            <div class="col-12">
                <form action="<?php echo $base_url;?>/cart-update.php" method="post" >
                    <table class= "table table-border-onfo">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <?php while($product = mysqli_fetch_assoc($query)): ?>
                            <tr>
                                ...
                                <td>
                                    <a onclick="return confirm('Are your sure you want to delete?');"role="button" href="<?php echo $base_url; ?>/cart-delete.php?ID=<?php echo $product['ID']; ?>" class="btn btn-outline-danger"><i class="fa-solid fa-trash"></i>Delete</a>
                                </td>
                            </tr>
                            <?php endwhile; ?>  
                            <tr>
                        ...
                        <?php else: ?>
                        <tr>
                            <td colspan="6"><h4 class="text-center text-danger">ไม่มีรายการสินค้าในตะกล้า</h4></td>
                        <tr>
                        <?php endif; ?>
                    </tbody>
                </table>
